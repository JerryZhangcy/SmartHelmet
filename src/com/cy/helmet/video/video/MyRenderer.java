...
import com.cy.helmet.video.camera.CameraUtils;
import com.cy.helmet.video.camera.exception.CameraDisabledException;
...
import com.cy.helmet.video.camera.exception.NoCameraException;
...
import com.cy.helmet.video.video.effect.Effect;
import com.cy.helmet.video.video.effect.NullEffect;
...
public class MyRenderer implements GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    ...
    public MyRenderer(GLSurfaceView view) {
        ...
        mVideoConfiguration = VideoConfiguration.getRecordingConfig();
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        //take photo snot if necessary
//        takePhotoInNecessary();
    }
    ...
    public void setWatermark(Watermark watermark) {
        ...
        // do not show water mark on preview screen
//        if (mRenderScreen != null) {
