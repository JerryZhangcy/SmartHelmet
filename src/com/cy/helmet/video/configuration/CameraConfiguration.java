...
public final class CameraConfiguration {
    public static final int DEFAULT_HEIGHT = 1200;//modify by Jerry
    public static final int DEFAULT_WIDTH = 1600;//modify by Jerry
    public static final int DEFAULT_FPS = 15;
    public static final Facing DEFAULT_FACING = Facing.BACK;
    public static final Orientation DEFAULT_ORIENTATION = Orientation.LANDSCAPE; //modify by Jerry
