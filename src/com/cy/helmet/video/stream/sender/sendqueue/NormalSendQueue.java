...
import static com.cy.helmet.video.entity.Frame.FRAME_TYPE_AUDIO;
import static com.cy.helmet.video.entity.Frame.FRAME_TYPE_INTER_FRAME;
import static com.cy.helmet.video.entity.Frame.FRAME_TYPE_KEY_FRAME;

public class NormalSendQueue implements ISendQueue {
    public static final int NORMAL_FRAME_BUFFER_SIZE = 800;
    public static final int MIN_FRAME_BUFFER_SIZE = 100;
    ...
    public void init(int frameSize) {
        if (frameSize > MIN_FRAME_BUFFER_SIZE) {
            mFullQueueCount = frameSize;
        }
        mFrameBuffer = new ArrayBlockingQueue<>(mFullQueueCount, true);
    }
